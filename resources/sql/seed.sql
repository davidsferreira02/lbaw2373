...
('Eva Watson', 'eva_watson', '$2y$10$2GjBcLxfjx05sYwQsBp9gefXeA0u.NTVcQsVPUmjA5a6o3Rd/eZW.', 'eva@example.com'),
('Noah Adams', 'noah_adams', '$2y$10$fOyYNW8rD4xiL8GgrbCim.7JQ0EBjZz2SEvSVKktjMvEcs8V9Za.K', 'noah@example.com'),
('Isabella Wood', 'isabella_wood', '$2y$10$F/00D/RNZMbmrWBrOCSmVewWVbDL1zlsKmGVsu79xTGrVKe9PS9yq', 'isabella@example.com'),
('James White', 'james_white', '$2y$10$96AnEZJCGYiXUjyRmTLazek2s6Jg6ltO01T47/zbUBT.gBwS6EnVu', 'james2@example.com'),
('Sophia Harris', 'sophia_harris', '$2y$10$QR.UhGKyB.KWKLX5kQsC6uR71G6sYIWYk3NHuLXK8T9dLe2JmFvam', 'sophia2@example.com'),
('Oliver Young', 'oliver_young', '$2y$10$Q4JYqShVywabOhvl.yJX/.gdw67cwS1KydTpMWKZJN8q1X/J0AC/e', 'oliver@example.com'),
('Amelia King', 'amelia_king', '$2y$10$QKYx1dPMZ2en9pVumqq09e/vTK0aInyJGup4B.izxDRhNTbbiqEZK', 'amelia2@example.com'),
('Lucas Baker', 'lucas_baker', '$2y$10$Q7V0vKcc7sBqSVIjQGt2kOdqw7bGqYfZq7X1KjwEm8NlQ8yM7vDR2', 'lucas2@example.com'),
('Aria Evans', 'aria_evans', '$2y$10$HWq0IqN9NlwHz9.CxUbgPey9HxZv2S0P5RtYkOYR6a/dGPE6tYrly', 'aria2@example.com'),
('Logan Parker', 'logan_parker', '$2y$10$JNXO2zCfKFxenFm1MEnkLe9eAuziM9z7/3f.SqE5tSKQztvy9BqJq', 'logan2@example.com'),
('Evelyn Coleman', 'evelyn_coleman', '$2y$10$fc2m8Q91iIX17AwhfRJz0.g88lYjE1JdKwYL/yA6ND1u2tPAnvW0C', 'evelyn2@example.com'),
('Carter Wright', 'carter_wright', '$2y$10$eAKrHNXoRfYBVFb2Ae9rxeR0sJTuU8UKjotkE9w5e.nvQdeKSuQUK', 'carter2@example.com'),
('Luna Ross', 'luna_ross', '$2y$10$Xa3PCWmbz/BEzG9LjOzgqeGyckifQtTxKDvQdeF.9gMxcjSOxQ7.2', 'luna2@example.com'),
('Mason Ward', 'mason_ward', '$2y$10$pm8bFupY9SDWsmVC4pT13OZuq9ltc/KxP7yDkAH5MLquKdAFR3p/S', 'mason2@example.com'),
('Harper Peterson', 'harper_peterson', '$2y$10$gS2aH0hT4t.8Nu01dETJveJxt3aEY3NbJas9cQzRZFX/nxd2NSb.2', 'harper2@example.com'),
('Elijah Sanchez', 'elijah_sanchez', '$2y$10$JNXO2zCfKFxenFm1MEnkLe9eAuziM9z7/3f.SqE5tSKQztvy9BqJq', 'elijah2@example.com'),
('Avery Price', 'avery_price', '$2y$10$Q4JYqShVywabOhvl.yJX/.gdw67cwS1KydTpMWKZJN8q1X/J0AC/e', 'avery2@example.com'),
('Nova Martinez', 'nova_martinez', '$2y$10$QKYx1dPMZ2en9pVumqq09e/vTK0aInyJGup4B.izxDRhNTbbiqEZK', 'novamar@example.com'),
